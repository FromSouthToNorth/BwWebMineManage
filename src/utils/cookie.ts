...
/** 共享 Cookies 实例，避免重复创建工厂闭包 */
const _cookies = Cookies(window)

export function getAccessToken(): string | undefined {
    return _cookies.get('Access-Token')
}

export function setAccessToken(token: string): void {
    _cookies.set('Access-Token', token)
}

export function removeAccessToken(): void {
    _cookies.remove('Access-Token')
}

export function getToken(): string | undefined {
    return _cookies.get('token')
}

export function getMineDesc(): string | undefined {
    return _cookies.get('MineDesc')
}

export function getMineName(): string | undefined {
    return _cookies.get('MineName')
}
