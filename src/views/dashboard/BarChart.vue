  ...
  <div class="stat-chart">
    ...
    <div class="stat-chart__header">
      <div class="stat-chart__title">
        <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.5" style="flex-shrink: 0;">
...
async function initChart() {
  ...
  try {
    ...
    setOption({
      ...
      grid: { top: 8, bottom: 28, left: 36, right: 8, containLabel: true },
      xAxis: {
        type: 'category',
        ...
        axisLabel: {
          ...
          fontSize: 10,
          interval: 0,
          rotate: categories.value.length > 6 ? 40 : 0,
          overflow: 'truncate',
          width: 60,
        },
      ...
      series: [{
        ...
        emphasis: {
          ...
          itemStyle: {
            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
              { offset: 0, color: cssVar('--chart-2') || '#f59e0b' },
              { offset: 1, color: cssVar('--color-primary') || '#3b82f6' },
            ]),
            shadowBlur: 10,
    ...
    const ro = new ResizeObserver(() => calcSegments())
